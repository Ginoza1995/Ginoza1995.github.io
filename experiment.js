...
var instr_as = {
    ...
    pages: [
        `<p>接下来要做的是一个数图推理测验，它能较好地反应一个人的逻辑推理能力。每道题中的选项的得分有所不同，最低0分，最高5分。请看下面的例题：</p><img src="images/例.png"><p>在这张图中，上面的图像是缺了一部分的，图案下面的小图片的形状都与上图所缺部分一样，但内容不同，不是每一张小图片都能补全上面的图案。请看第一张小图片，显然不行，第二、三张也对不上，第六张好像可以，但也有一小块空白。最后只有第四张是最合适的，所以，4将获得最高得分。</p><p><b style="color:#a70b0b">每题限时30秒，共11题，请尽力作答</b></p>`,
    ],
    show_clickable_nav: true,
    allow_backward: false,
    button_label_previous: '返回',
...
var rank = {
    ...
    pages: function(){
        ...
        var ads = [];
        var str = "<p>历史得分排名</p><table id='rank'><thead style='text-align:center;'><tr><th>名次(55/55)</th><th>姓名</th><th>学历</th><th style='width:100px;'>分数</th></tr></thead><tbody><tr><td>1</td><td>余庆华</td><td>硕士以上</td><td>55</td></tr><tr><td>1</td><td>施囡</td><td>硕士及硕士在读</td><td>55</td></tr><tr><td>3</td><td>王维俊</td><td>硕士及硕士在读</td><td>54</td></tr><tr><td>3</td><td>广姗然</td><td>硕士及硕士在读</td><td>54</td></tr><tr><td>5</td><td>王慧敏</td><td>本科及本科在读</td><td>53</td></tr><tr><td>.</td><td>.</td><td>.</td><td>.</td></tr><tr><td>.</td><td>.</td><td>.</td><td>.</td></tr><tr><td>.</td><td>.</td><td>.</td><td>.</td></tr><tr><td>40</td><td>王汉华</td><td>大专及大专在读</td><td>21</td></tr><tr style='background-color:skyblue;'><td>41</td><td>"+subName+"</td><td>"+xl+"</td><td>20</td></tr><tr><td>41</td><td>秋瑾兰</td><td>其他</td><td>20</td></tr><tr><td>.</td><td>.</td><td>.</td><td>.</td></tr><tr><td>.</td><td>.</td><td>.</td><td>.</td></tr></tbody></table>";
        ads[0]=str;
        return ads
    },
    show_clickable_nav: true,
